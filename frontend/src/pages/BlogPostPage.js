 ...
 function BlogPostPage() {
  ...
  fullContent: [
    ...
    { type: 'list', items: [
      ...
      '<strong>Shape the momos:</strong> Divide the dough into small balls. Roll each ball into a thin circle. Place a spoonful of the filling in the center of the circle. Bring the edges together to create your desired momo shape (e.g., crescent, round).',
